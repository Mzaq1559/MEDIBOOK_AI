...
class Patient(Base):
    ...
    date_of_birth = Column(Date, nullable=False, default=date(1990, 1, 1))
    gender = Column(String(10), nullable=False, default="M")  # 'M', 'F', 'Other'
    blood_type = Column(String(5), nullable=True)
    allergies = Column(Text, nullable=True, default="[]")
    medical_conditions = Column(Text, nullable=True, default="[]")
    emergency_contact_name = Column(String(255), nullable=False, default="Emergency Contact")
    emergency_contact_phone = Column(String(15), nullable=False, default="03000000000")
